      ...
      >
        <div className="mb-8">
          ...
          <div className="flex items-center mb-4">
            ...
            <h1 className="text-heading">Admin Registration</h1>
          </div>
          <p className="text-body text-muted-foreground">
            Request admin access for ExploreNow
          </p>
        </div>
        ...
        <Card className="border-0 shadow-elegant-lg">
          <CardContent className="p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button
                type="submit"
                className="bg-white text-black dark:bg-black dark:text-white hover:opacity-90 px-4 py-2 rounded w-full"
                disabled={isLoading}
              >
                {isLoading ? (
                  <>
